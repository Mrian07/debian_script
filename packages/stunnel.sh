...
COUNTRY=$(grep -sw 'COUNTRY' /usr/local/cybertize/utility/.env | cut -d '=' -f 2 | tr -d '"')
STATE=$(grep -sw 'STATE' /usr/local/cybertize/utility/.env | cut -d '=' -f 2 | tr -d '"')
REGION=$(grep -sw 'REGION' /usr/local/cybertize/utility/.env | cut -d '=' -f 2 | tr -d '"')
ORG=$(grep -sw 'ORG' /usr/local/cybertize/utility/.env | cut -d '=' -f 2 | tr -d '"')
UNIT=$(grep -sw 'UNIT' /usr/local/cybertize/utility/.env | cut -d '=' -f 2 | tr -d '"')
